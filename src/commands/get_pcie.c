...
static const UtoolOutputMapping getPCIeDeviceMappings[] = {
        ...
        {.sourceXpath = "/Model", .targetKeyValue="Type"},
        {.sourceXpath = "/Null", .targetKeyValue="SlotBus"},
        {.sourceXpath = "/Null", .targetKeyValue="SlotDevice"},
        {.sourceXpath = "/Null", .targetKeyValue="SlotFunction"},
